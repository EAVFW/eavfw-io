...
import { OpenCloseList, OpenCloseListProvider, ToggleButton } from "./OpenCloseList.client";
...
export const DocsNavTopic = ({ categoryId, topicId }: DocsNavArticlesProps) => {
    ...
    return (
        ...
        <li aria-labelledby=":Rlj36:" className="Box-sc-g0xbh4-0 Ywlla">
            <OpenCloseListProvider>
                <ToggleButton tabIndex={0} aria-labelledby=":Rlj36:--label " id=":Rlj36:" aria-expanded="false" aria-controls=":Rlj36H1:" className="Item__LiBox-sc-yeql7o-0 fOqRlj">
                    <div data-component="ActionList.Item--DividerContainer" className="Box-sc-g0xbh4-0 hROlum">
